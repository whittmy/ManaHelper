...
NetworkAccessMgr::NetworkAccessMgr(QObject *parent)
...
QNetworkReply* NetworkAccessMgr::createRequest(Operation op, const QNetworkRequest & req, QIODevice * outgoingData)
{
...
void NetworkAccessMgr::requestFinished(QNetworkReply *reply)
{
...
void NetworkAccessMgr::loadSettings()
{
    QSettings settings;
...
#ifndef QT_NO_OPENSSL
void NetworkAccessMgr::sslErrors(QNetworkReply *reply, const QList<QSslError> &error)
{
