...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        DownloadsTable->setDragDropOverwriteMode(true);
        DownloadsTable->setDragDropMode(QAbstractItemView::DragDrop);
        DownloadsTable->setDefaultDropAction(Qt::TargetMoveAction);
        ...
        DownloadsTable->setSortingEnabled(false);
        ...
        dockCategories->setMaximumSize(QSize(184, 513));
        dockCategories->setStyleSheet(QStringLiteral("border-color: rgb(0, 0, 0);"));
        dockCategories->setFeatures(QDockWidget::DockWidgetClosable);
        ...
        categoriesTree->setMaximumSize(QSize(166, 470));
