...
public:
    ...
    void retranslateUi(QDialog *DownloadPropertyDialog)
    {
        ...
        filenamelabel->setText(QApplication::translate("DownloadPropertyDialog", "Filename", 0));
        label_3->setText(QApplication::translate("DownloadPropertyDialog", "Status", 0));
        statuslabel->setText(QApplication::translate("DownloadPropertyDialog", "status", 0));
        label_4->setText(QApplication::translate("DownloadPropertyDialog", "Size", 0));
        sizelabel->setText(QApplication::translate("DownloadPropertyDialog", "size", 0));
        label_5->setText(QApplication::translate("DownloadPropertyDialog", "Saved to", 0));
        savedtolabel->setText(QApplication::translate("DownloadPropertyDialog", "savedto", 0));
        ...
        lastTryDateLabel->setText(QApplication::translate("DownloadPropertyDialog", "last try date", 0));
        label_11->setText(QApplication::translate("DownloadPropertyDialog", "Date Added", 0));
        dateAddedLabel->setText(QApplication::translate("DownloadPropertyDialog", "date added", 0));
